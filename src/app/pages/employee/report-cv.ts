...
@Component({
    ...
    template: ` <div class="card">
            <div class="font-semibold text-xl mb-4">Report CV</div>
            <div class="flex justify-between items-center flex-column sm:flex-row">
                <div class="mb-4">
                    <div class="flex flex-col gap-2 w-150 mb-4">
                        <label for="idkaryawan">ID Karyawan :</label>
                        <input pInputText id="idemployee" type="text" class="form-control form-control-m" />
                    </div>
...
export class ReportCV implements OnInit {
    customers1: Customer[] = [];
